(function () {
  ...
  /* Letter entrance animation only on the home page */
  ...
  /* Keep the link for the current section highlighted after navigation. */
  ...
  /* Clicking the name while already on the home page replays the letter swing. */
