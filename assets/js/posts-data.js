(function () {
  window.sitePosts = [
    ...
    },
    {
      ...
      readTime: '1 min read',
      href: {
        en: 'pages/en/posts/heptascript/',
        de: 'pages/en/posts/heptascript/'
      },
      language: 'en',
      tags: ['Project']
    },
    {
      id: 'starting',
      title: 'Starting',
      summary: 'A short first note about what this page is for, why I want to write here, and what kind of posts I want to collect over time.',
      date: '2026-05-26',
      readTime: '1 min read',
      href: {
